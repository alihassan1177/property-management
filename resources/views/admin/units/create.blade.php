        ...
        <div class="row g-5">
            ...
            <div class="col-lg-6">
                ...
                <div class="d-flex gap-4 align-items-center justify-content-between mb-3">
                    ...
                    <input type="text" name="total_area" style="max-width: 300px;" class="form-control">
                    @error('total_area')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="d-flex gap-4 align-items-center justify-content-between mb-3">
                    ...
                    <input type="text" name="floors" style="max-width: 300px;" class="form-control">
                    @error('floors')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="d-flex gap-4 align-items-center justify-content-between mb-3">
                    ...
                    <input type="text" name="number_of_beds" style="max-width: 300px;" class="form-control">
                ...
                <div class="d-flex gap-4 align-items-center justify-content-between mb-3">
                    ...
                    <input  name="number_of_baths" type="text" style="max-width: 300px;" class="form-control">
            ...
            <div class="col-lg-6">
                ...
                <div class="d-flex gap-4 mb-3 align-items-center justify-content-between">
                    <p class="m-0">Rent Amount:</p>
                    <input type="text" name="rent_amount" style="max-width: 300px;" class="form-control">
                    @error('rent_amount')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="d-flex gap-4 mb-3 align-items-center justify-content-between">
                    ...
                    <input type="text" name="security_deposit" style="max-width: 300px;" class="form-control">
                ...
                <div class="d-flex gap-4 mb-3 align-items-center justify-content-between">
                    ...
                    <input type="text" name="rental_period" style="max-width: 300px;" class="form-control">
                    @error('rental_period')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
